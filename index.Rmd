...
3. Estime el modelo de regresión lineal simple entre $precio = f(area)+ \varepsilon$. Interprete los coeficientes del modelo $\beta_{0}$, $\beta_{1}$ en caso de ser correcto.
...
11. Con los resultados obtenidos construya un informe para los directivos de la inmobiliaria
